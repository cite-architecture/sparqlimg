...
var IIP = new Class({
  ...
  createWindows: function(){
    ...
    new Element('img', {src: 'css/images/iip.32x32.png', id: 'info', styles: { opacity: 0.8 } } ).injectInside('logo');

    // Fix IE7 PNG transparency problem
    if( Browser.Engine.trident5 ){
      $('info').setStyle( 'filter', 'progid:DXImageTransform.Microsoft.AlphaImageLoader(enabled=true,src="css/images/iip.32x32.png",sizingMethod=scale)' );
    }
  ...
  createNavigationWindow: function() {
   ...
   var loadBarContainer = new Element('div', {
	...
	id: 'navbuttons',
	html: '<img id="shiftLeft" src="css/images/left.png"/><img id="shiftUp" src="css/images/up.png"/><img id="shiftRight" src="css/images/right.png"/><br/><img id="shiftDown" src="css/images/down.png"/><br/><img id="zoomIn" src="css/images/zoomIn.png"/><img id="zoomOut" src="css/images/zoomOut.png"/><img id="reset" src="css/images/reset.png"/>'
    });
  ...
  positionZone: function(){
	...
	highlightROI: function(){
			...
			ROIZone.addEvent( 'click',function(tempURL){ 
				...
				var tempURL = "api?request=GetBinaryImage&urn=" + iip.imgURN;
				tempURL += "&w=8000";				
				open(tempURL);
